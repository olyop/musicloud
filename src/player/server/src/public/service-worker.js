...
/***/ "./src/player/service-worker/src/index.ts":
/*!************************************************!*\
  !*** ./src/player/service-worker/src/index.ts ***!
  \************************************************/
...
/* harmony import */ var workbox_range_requests__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! workbox-range-requests */ "./node_modules/workbox-range-requests/index.mjs");
/* harmony import */ var workbox_strategies__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! workbox-strategies */ "./node_modules/workbox-strategies/index.mjs");
...
(0,workbox_recipes__WEBPACK_IMPORTED_MODULE_0__.pageCache)();
(0,workbox_recipes__WEBPACK_IMPORTED_MODULE_0__.googleFontsCache)();
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_2__.registerRoute)(({ url }) => url.pathname.endsWith(".mp3"), new workbox_strategies__WEBPACK_IMPORTED_MODULE_5__.CacheFirst({
    cacheName: "mp3s",
    plugins: [
        new workbox_range_requests__WEBPACK_IMPORTED_MODULE_4__.RangeRequestsPlugin(),
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_2__.registerRoute)(({ url }) => url.pathname === "/ping.txt", new workbox_strategies__WEBPACK_IMPORTED_MODULE_5__.NetworkOnly());
...
/* harmony export */ });
/* harmony import */ var _createPartialResponse_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createPartialResponse.js */ "./node_modules/workbox-range-requests/createPartialResponse.js");
/* harmony import */ var _version_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_version.js */ "./node_modules/workbox-range-requests/_version.js");
/* harmony import */ var _version_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_version_js__WEBPACK_IMPORTED_MODULE_1__);
/*
  Copyright 2018 Google LLC
    ...
    constructor() {
        ...
        this.cachedResponseWillBeUsed = async ({ request, cachedResponse, }) => {
            ...
            if (cachedResponse && request.headers.has('range')) {
                return await (0,_createPartialResponse_js__WEBPACK_IMPORTED_MODULE_0__.createPartialResponse)(request, cachedResponse);
            }
...
/* harmony export */ });
/* harmony import */ var workbox_core_private_WorkboxError_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! workbox-core/_private/WorkboxError.js */ "./node_modules/workbox-core/_private/WorkboxError.js");
/* harmony import */ var workbox_core_private_assert_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! workbox-core/_private/assert.js */ "./node_modules/workbox-core/_private/assert.js");
/* harmony import */ var workbox_core_private_logger_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! workbox-core/_private/logger.js */ "./node_modules/workbox-core/_private/logger.js");
/* harmony import */ var _utils_calculateEffectiveBoundaries_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/calculateEffectiveBoundaries.js */ "./node_modules/workbox-range-requests/utils/calculateEffectiveBoundaries.js");
/* harmony import */ var _utils_parseRangeHeader_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/parseRangeHeader.js */ "./node_modules/workbox-range-requests/utils/parseRangeHeader.js");
/* harmony import */ var _version_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_version.js */ "./node_modules/workbox-range-requests/_version.js");
/* harmony import */ var _version_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_version_js__WEBPACK_IMPORTED_MODULE_5__);
/*
  Copyright 2018 Google LLC
...
async function createPartialResponse(request, originalResponse) {
    try {
        if (true) {
            workbox_core_private_assert_js__WEBPACK_IMPORTED_MODULE_1__.assert.isInstance(request, Request, {
                moduleName: 'workbox-range-requests',
                funcName: 'createPartialResponse',
                paramName: 'request',
            });
            workbox_core_private_assert_js__WEBPACK_IMPORTED_MODULE_1__.assert.isInstance(originalResponse, Response, {
                moduleName: 'workbox-range-requests',
                funcName: 'createPartialResponse',
        ...
        if (!rangeHeader) {
            throw new workbox_core_private_WorkboxError_js__WEBPACK_IMPORTED_MODULE_0__.WorkboxError('no-range-header');
        }
        const boundaries = (0,_utils_parseRangeHeader_js__WEBPACK_IMPORTED_MODULE_4__.parseRangeHeader)(rangeHeader);
        const originalBlob = await originalResponse.blob();
        const effectiveBoundaries = (0,_utils_calculateEffectiveBoundaries_js__WEBPACK_IMPORTED_MODULE_3__.calculateEffectiveBoundaries)(originalBlob, boundaries.start, boundaries.end);
        ...
        if (true) {
            workbox_core_private_logger_js__WEBPACK_IMPORTED_MODULE_2__.logger.warn(`Unable to construct a partial response; returning a ` +
                `416 Range Not Satisfiable response instead.`);
            workbox_core_private_logger_js__WEBPACK_IMPORTED_MODULE_2__.logger.groupCollapsed(`View details here.`);
            workbox_core_private_logger_js__WEBPACK_IMPORTED_MODULE_2__.logger.log(error);
            workbox_core_private_logger_js__WEBPACK_IMPORTED_MODULE_2__.logger.log(request);
            workbox_core_private_logger_js__WEBPACK_IMPORTED_MODULE_2__.logger.log(originalResponse);
            workbox_core_private_logger_js__WEBPACK_IMPORTED_MODULE_2__.logger.groupEnd();
        }
        return new Response('', {
            status: 416,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "RangeRequestsPlugin": () => (/* reexport safe */ _RangeRequestsPlugin_js__WEBPACK_IMPORTED_MODULE_1__.RangeRequestsPlugin),
/* harmony export */   "createPartialResponse": () => (/* reexport safe */ _createPartialResponse_js__WEBPACK_IMPORTED_MODULE_0__.createPartialResponse)
/* harmony export */ });
/* harmony import */ var _createPartialResponse_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createPartialResponse.js */ "./node_modules/workbox-range-requests/createPartialResponse.js");
/* harmony import */ var _RangeRequestsPlugin_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./RangeRequestsPlugin.js */ "./node_modules/workbox-range-requests/RangeRequestsPlugin.js");
/* harmony import */ var _version_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_version.js */ "./node_modules/workbox-range-requests/_version.js");
/* harmony import */ var _version_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_version_js__WEBPACK_IMPORTED_MODULE_2__);
/*
  Copyright 2018 Google LLC
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "calculateEffectiveBoundaries": () => (/* binding */ calculateEffectiveBoundaries)
/* harmony export */ });
/* harmony import */ var workbox_core_private_WorkboxError_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! workbox-core/_private/WorkboxError.js */ "./node_modules/workbox-core/_private/WorkboxError.js");
/* harmony import */ var workbox_core_private_assert_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! workbox-core/_private/assert.js */ "./node_modules/workbox-core/_private/assert.js");
/* harmony import */ var _version_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_version.js */ "./node_modules/workbox-range-requests/_version.js");
...
function calculateEffectiveBoundaries(blob, start, end) {
    if (true) {
        workbox_core_private_assert_js__WEBPACK_IMPORTED_MODULE_1__.assert.isInstance(blob, Blob, {
            moduleName: 'workbox-range-requests',
    ...
    if ((end && end > blobSize) || (start && start < 0)) {
        throw new workbox_core_private_WorkboxError_js__WEBPACK_IMPORTED_MODULE_0__.WorkboxError('range-not-satisfiable', {
            size: blobSize,
            end,
            start,
        });
...
function parseRangeHeader(rangeHeader) {
    if (true) {
        workbox_core_private_assert_js__WEBPACK_IMPORTED_MODULE_1__.assert.isType(rangeHeader, 'string', {
            moduleName: 'workbox-range-requests',
    ...
    if (!normalizedRangeHeader.startsWith('bytes=')) {
        throw new workbox_core_private_WorkboxError_js__WEBPACK_IMPORTED_MODULE_0__.WorkboxError('unit-must-be-bytes', { normalizedRangeHeader });
    }
    // Specifying multiple ranges separate by commas is valid syntax, but this
    // library only attempts to handle a single, contiguous sequence of bytes.
    // https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Range#Syntax
    if (normalizedRangeHeader.includes(',')) {
        throw new workbox_core_private_WorkboxError_js__WEBPACK_IMPORTED_MODULE_0__.WorkboxError('single-range-only', { normalizedRangeHeader });
    }
    const rangeParts = /(\d*)-(\d*)/.exec(normalizedRangeHeader);
    // We need either at least one of the start or end values.
    if (!rangeParts || !(rangeParts[1] || rangeParts[2])) {
        throw new workbox_core_private_WorkboxError_js__WEBPACK_IMPORTED_MODULE_0__.WorkboxError('invalid-range-values', { normalizedRangeHeader });
    }
    return {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "RangeRequestsPlugin": () => (/* reexport safe */ _index_js__WEBPACK_IMPORTED_MODULE_0__.RangeRequestsPlugin),
/* harmony export */   "createPartialResponse": () => (/* reexport safe */ _index_js__WEBPACK_IMPORTED_MODULE_0__.createPartialResponse)
/* harmony export */ });
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ "./node_modules/workbox-range-requests/index.js");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/player/service-worker/src/index.ts");
/******/ 	
/******/ })()
;