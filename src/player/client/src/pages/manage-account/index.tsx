...
import Modal, { ModalHeader, ModalButton, ModalButtons } from "../../components/modal";
...
const bem = createBEM("ManageAccount");
...
const ManageAccount: FC = () => {
	...
	const handleNewPasswordChange: InputOnChange = value => setNewPassword(value);
	...
	const handleDeleteUserModalOpen = () => setDeleteUserModal(true);
		...
		<Head pageTitle="Manage Account">
			<Page>
				<div className={bem("", "Content PaddingTopBottom FlexColumnGapHalf")}>
					<Button icon="password" text="Change Password" onClick={handleChangePasswordModalOpen} />
					<Modal
						open={changePasswordModal}
						onClose={handleChangePasswordModalClose}
						className="Padding"
					>
						<h1 className="HeadingFive MarginBottom">Change Password</h1>
						<Input
							tabIndex={1}
							type="password"
							name="Password"
						...
						<div className="FlexRowGapHalf">
							<Button icon="edit" tabIndex={2} text="Submit" onClick={handleChangePasswordSubmit} />
							<Button
								transparent
								icon="close"
								text="Close"
					...
					<Modal open={deleteUserModal} onClose={handleDeleteUserModalClose}>
						...
						/>
						<ModalButtons>
							<ModalButton text="Delete" icon="delete" onClick={handleDeleteUser} />
							<ModalButton text="Cancel" icon="arrow_back" onClick={handleDeleteUserModalClose} />
						</ModalButtons>
					</Modal>
					<Button text="Logout" onClick={signOut} icon="exit_to_app" />
				</div>
			</Page>
		</Head>
	);
