...
const observerMap = new Map<string, ObserverInstance>();
...
export const defaultFallbackInView = (inView: boolean | undefined) => {
...
export const optionsToID = (options: IntersectionObserverInit) => {
