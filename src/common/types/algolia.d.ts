import { ObjectID, UserBase, SongBase, GenreBase, AlbumBase, TypeNames, ArtistBase, PlaylistBase, UserIDNameBase, GenreIDNameBase, AlbumIDTitleBase, ArtistIDNameBase } from "./objects";
export declare type AlgoliaRecordTypeName = Exclude<TypeNames, "Key" | "Play">;
...
export interface AlgoliaRecordUser extends AlgoliaRecordImage, AlgoliaRecordBase<"User">, Pick<UserBase, "name" | "emailAddress"> {
    followers: number;
}
...
export interface AlgoliaRecordAlbum extends AlgoliaRecordImage, AlgoliaRecordPlays, Omit<AlbumBase, "albumID">, AlgoliaRecordBase<"Album"> {
    artists: ArtistIDNameBase[];
}
...
export interface AlgoliaRecordPlaylist extends AlgoliaRecordPlays, AlgoliaRecordBase<"Playlist">, Omit<PlaylistBase, "playlistID" | "dateCreated"> {
    user: UserIDNameBase;
}
