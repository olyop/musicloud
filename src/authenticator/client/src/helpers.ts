...
import { determineServiceURL, RedirectOptions } from "@oly_op/musicloud-common/build/determine-service-url"

export const isValidServiceName =
	(value: ReturnType<URLSearchParams["get"]>): value is ServicesNames => {
		if (isNull(value)) {
			return false
...
interface CreateRedirectURLOptions
	extends RedirectOptions, AccessToken {}

export const createRedirectURL =
	({ accessToken, redirect }: CreateRedirectURLOptions) => {
