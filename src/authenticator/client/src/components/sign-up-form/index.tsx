...
const SignUpForm: FC<PropTypes> = ({ onSubmit, emailAddress, onEmailAddressChange }) => {
	...
	const handleNameChange: InputOnChange = value => setName(value);

	const handlePasswordChange: InputOnChange = value => setPassword(value);

	const handleCoverChange: InputOnChange<File> = value => setCover(value);

	const handleProfileChange: InputOnChange<File> = value => setProfile(value);
	...
	const handleSignUp = async () => {
		...
		const data = (await response.json()) as DataOk | DataError;
